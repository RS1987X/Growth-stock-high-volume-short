...
for x in tickers:
    data = pd.read_csv('OMXSTO_DLY_'+x+', 5.csv')
    ...
    full_day_dates = data[data["TimePart"] == "17:25:00"]["DatePart"].to_frame()
    ...
    half_days_data["TimePart"] == "12:55:00"
    
    
    #EXIT PRICES for both half and full sessions
    exit_price_half_day = half_days_data[half_days_data["TimePart"] == "12:55:00"]["close"]
    exit_price_full_days = data[data["TimePart"] == "17:25:00"]["close"]
